...
plate_width = 50 #ความกว้าง
plate_hight = 50#ความยาว

max_iter_time = 500 #วนลูป ทำงานมากสุด 500 รอบ
...
def calculate(u): #คำนวนค่า
    for k in range(0, max_iter_time -1, 1): #เริ่มจาก0-499 ไปทีละ1
        for i in range(1, plate_hight -1, delta_x): #iความสูงเริ่ม1-49 ที่ละ1
            for j in range(1, plate_width -1, delta_x): #jความสูงเริ่ม1-49 ที่ละ1
